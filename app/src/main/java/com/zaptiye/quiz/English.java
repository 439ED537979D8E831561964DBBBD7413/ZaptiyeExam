...
public class English extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String pdfURL = "http://sirnak.edu.tr/birimler/ydbb/dosya/belgeler/active_grammer.pdf";
        ...
        final ProgressDialog progress = ProgressDialog.show(this, "ingilizce Notlar", "Yukleniyor....", true);
        progress.show();
