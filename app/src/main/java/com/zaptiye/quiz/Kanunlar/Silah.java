...
public class Silah extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.kanunlar_silah);

        WebView webView = (WebView) findViewById(R.id.webview);
        webView.loadUrl("https://docs.google.com/document/d/1Sd1d8g6eKtJH_EtEFJHKShDTcwRxgIZKbTeiPssNbtU/edit");
        ...
        final ProgressDialog progress = ProgressDialog.show(this, "Ateþli Silahlar Hakkýnda Kanun", "Yükleniyor....", true);
        progress.show();
